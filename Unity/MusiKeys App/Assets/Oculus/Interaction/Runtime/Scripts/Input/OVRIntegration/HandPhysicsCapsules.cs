    ...
    public class HandPhysicsCapsules : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            for (int i = 0; i < _capsules.Count; ++i)
            {
                ...
                string tester = (boneTransform.name).ToString() + "_CapsuleCollider";
                if (tester == "b_l_middle3_CapsuleCollider" ||
                    tester == "b_l_index3_CapsuleCollider" ||
                    tester == "b_l_pinky3_CapsuleCollider" ||
                    tester == "b_r_middle3_CapsuleCollider" ||
                    tester == "b_r_index3_CapsuleCollider" ||
                    tester == "b_r_pinky3_CapsuleCollider")
                {
                    capsule.CapsuleCollider.gameObject.layer = LayerMask.NameToLayer("Fingertips");
                }
                else if (tester == "b_l_thumb3_CapsuleCollider" ||
                    tester == "b_r_thumb3_CapsuleCollider")
                {
                    capsule.CapsuleCollider.gameObject.layer = LayerMask.NameToLayer("Thumbtips");
                }
